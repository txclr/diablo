...
CGloves::CGloves(float _fX, float _fY, ITEMSTATE::STATE _eState)
{
	m_tInfo.fX = _fX;
	m_tInfo.fY = _fY;
	m_eState = _eState;
...
void CGloves::FieldRender(HDC _DC)
{
...
void CGloves::InfoRender(HDC _DC)
{
