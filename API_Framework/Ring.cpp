...
CRing::CRing(float _fX, float _fY, ITEMSTATE::STATE _eState)
{
	m_tInfo.fX = _fX;
	m_tInfo.fY = _fY;
	m_eState = _eState;
...
void CRing::Initialize()
{
	...
	m_tItemInfo = {};
	m_tItemInfo.iGold = 5000;
}

void CRing::FieldRender(HDC _DC)
{
