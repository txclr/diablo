...
CHpPotion::CHpPotion(float _fX, float _fY, ITEMSTATE::STATE _eState)
{
	m_tInfo.fX = _fX;
	m_tInfo.fY = _fY;
	m_eState = _eState;
...
void CHpPotion::Initialize()
{
	m_pFrameKey = L"HpPotion";
	m_pBackFrame = L"";
	m_pDropFrame = L"PotionDrop";
	m_tInfo.iCX = 52;
	m_tInfo.iCY = 38;
	m_eType = ITEMTYPE::USE;
	m_tItemInfo = {};
	m_tItemInfo.iHp = 100;
	m_tItemInfo.iGold = 100;
}

void CHpPotion::FieldRender(HDC _DC)
{
