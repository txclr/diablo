...
CArmor::CArmor(float _fX, float _fY, ITEMSTATE::STATE _eState)
{
	m_tInfo.fX = _fX;
	m_tInfo.fY = _fY;
	m_eState = _eState;
...
void CArmor::Initialize()
{
	...
	m_tItemInfo = {};
	m_tItemInfo.iLife = 10;
	m_tItemInfo.iGold = 200;
}

void CArmor::FieldRender(HDC _DC)
{
